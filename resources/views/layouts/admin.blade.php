      ...
      <div class="layout-container">
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          ...
          <ul class="menu-inner py-1">
            ...
            <!-- Employees -->
            <li class="menu-item {{ request()->routeIs('admin.employees*') ? 'active open' : '' }}">
              <a href="javascript:void(0);" class="menu-link menu-toggle">
              ...
              <ul class="menu-sub">
                ...
                <li class="menu-item {{ request()->routeIs('admin.employees.create') ? 'active' : '' }}">
            ...
            <!-- Devices -->
            <li class="menu-item {{ request()->routeIs('admin.devices*') ? 'active open' : '' }}">
              <a href="javascript:void(0);" class="menu-link menu-toggle">
                      ...
                      <a class="dropdown-item" href="#">
                        <div class="d-flex">
                          ...
                          <div class="flex-grow-1">
                            <span class="fw-semibold d-block">{{ session('admin_name', 'Admin') }}</span>
